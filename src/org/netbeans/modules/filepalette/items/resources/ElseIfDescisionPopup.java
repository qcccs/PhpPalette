...
import org.netbeans.modules.filepalette.items.ElseIfDescision;
 ...
 * @author Ian
 */
public class ElseIfDescisionPopup extends javax.swing.JPanel {

    private Dialog dialog = null;
    private DialogDescriptor descriptor = null;
    private boolean dialogOK = false;
    ElseIfDescision ifitem;
     ...
     * @param target  
     */
    public ElseIfDescisionPopup(ElseIfDescision item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-elseIfDescision");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel16, org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.jLabel16.text")); // NOI18N

        elseIfName.setEditable(true);
        try{
            elseIfName.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        elseIfOp.setModel(new comparitiveOperatorListModel());

        elseIfValue.setEditable(true);
        try{
            elseIfValue.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        org.openide.awt.Mnemonics.setLocalizedText(jLabel17, org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.jLabel17.text")); // NOI18N

        elseIfBody.setColumns(20);
        elseIfBody.setRows(5);
        elseIfBody.setText(org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.elseIfBody.text")); // NOI18N
        jScrollPane3.setViewportView(elseIfBody);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel18, org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.jLabel18.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addElseIfButton, org.openide.util.NbBundle.getMessage(ElseIfDescisionPopup.class, "ElseIfDescisionPopup.addElseIfButton.text")); // NOI18N
