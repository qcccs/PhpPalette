...
import org.netbeans.modules.filepalette.items.WhileLoop;
 ...
 * @author Ian
 */
public class WhileLoopPopup extends javax.swing.JPanel {
     ...
     * @param target  
     */
    public WhileLoopPopup(WhileLoop item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-WhileLoop");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel13, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel13.text")); // NOI18N

        whileName.setEditable(true);
        try{
            whileName.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        whileOp.setModel(new comparitiveOperatorListModel());

        whileValue.setEditable(true);
        try{
            whileValue.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        org.openide.awt.Mnemonics.setLocalizedText(jLabel14, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel14.text")); // NOI18N

        whileBody.setColumns(20);
        whileBody.setRows(5);
        whileBody.setText(org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.whileBody.text")); // NOI18N
        jScrollPane2.setViewportView(whileBody);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel15, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel15.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addWhileButton, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.addWhileButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel34, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel34.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel42, org.openide.util.NbBundle.getMessage(WhileLoopPopup.class, "WhileLoopPopup.jLabel42.text")); // NOI18N
    ...
    private void jLabel34MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel34MouseClicked
        // Help Page
        OpenHelpUrl o = new OpenHelpUrl("http://www.php.net/manual/en/control-structures.while.php");
