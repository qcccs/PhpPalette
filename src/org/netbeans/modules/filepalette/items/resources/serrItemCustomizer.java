...
import org.netbeans.modules.filepalette.items.incmacro;
 ...
 * @author Ian
 */
public class serrItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public serrItemCustomizer(incmacro item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-serr");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(serrItemCustomizer.class, "LBL_Customizer_InsertPrefix")
