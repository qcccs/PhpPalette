...
import org.netbeans.modules.filepalette.items.DocComment;
 ...
 * @author Ian
 */
public class DocCommentPopup extends javax.swing.JPanel {
     ...
     * @param target  
     */
    public DocCommentPopup(DocComment item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    private void initComponents() {
        ...
        varPane.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.varPane.border.title"))); // NOI18N
        varPane.setToolTipText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.varPane.toolTipText")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel4.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addJavaDoc, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.addJavaDoc.text")); // NOI18N
        addJavaDoc.setToolTipText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.addJavaDoc.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel33, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel33.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel1.text")); // NOI18N

        author.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.author.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel2.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel3.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel5.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel6.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.jLabel7.text")); // NOI18N

        param1.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.param1.text")); // NOI18N

        param2.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.param2.text")); // NOI18N

        param3.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.param3.text")); // NOI18N

        param4.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.param4.text")); // NOI18N

        paramReturn.setText(org.openide.util.NbBundle.getMessage(DocCommentPopup.class, "DocCommentPopup.paramReturn.text")); // NOI18N
