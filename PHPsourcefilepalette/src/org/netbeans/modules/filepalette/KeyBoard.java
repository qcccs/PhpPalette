...
/**
 *
 * @author Ian KeyBoard Class is a Robot Class wrapper with support or char
 * string input.
 */
public class KeyBoard {
    ...
    /**
     * Type takes a sequence of chars and sends them for processing one by one.
     *
     * @param characters
     */
    ...
    /**
     * doType Processes each keypress on a delay, giving the IDE time to catch
     * up.
     *
     * @param keyCodes
     * @param offset
