...
import org.netbeans.modules.filepalette.items.SwitchStatement;
 ...
 * @author Ian
 */
public class SwitchStatementPopup extends javax.swing.JPanel {

    private Dialog dialog = null;
    private DialogDescriptor descriptor = null;
    private boolean dialogOK = false;
    SwitchStatement ifitem;
     ...
     * @param target  
     */
    public SwitchStatementPopup(SwitchStatement item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-SwitchStatement");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(switchCaseButton, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.switchCaseButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel29, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel29.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel30, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel30.text")); // NOI18N

        try{
            testVariable.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel3.text")); // NOI18N

        caseNumber.setText(org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.caseNumber.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel5.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel4.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel2.text")); // NOI18N

        jLabel34.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/mass/qcc/qcccodewizard/Question.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel34, org.openide.util.NbBundle.getMessage(SwitchStatementPopup.class, "SwitchStatementPopup.jLabel34.text")); // NOI18N
    ...
    private void jLabel34MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel34MouseClicked
        // Help Page
        OpenHelpUrl o = new OpenHelpUrl("http://www.php.net/manual/en/control-structures.switch.php");
