...
import org.netbeans.modules.filepalette.items.NewFunction;
 ...
 * @author Ian
 */
public class NewFunctionPopup extends javax.swing.JPanel {
     ...
     * @param target  
     */
    public NewFunctionPopup(NewFunction item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-newFunction");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        varPane.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.varPane.border.title"))); // NOI18N
        varPane.setToolTipText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.varPane.toolTipText")); // NOI18N

        methodName.setEditable(true);
        methodName.setToolTipText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.methodName.toolTipText")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel4.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addMethodButton, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.addMethodButton.text")); // NOI18N
        addMethodButton.setToolTipText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.addMethodButton.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel33, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel33.text")); // NOI18N
        ...
        varPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.varPane1.border.title"))); // NOI18N
        varPane1.setToolTipText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.varPane1.toolTipText")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel5.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addJavaDoc, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.addJavaDoc.text")); // NOI18N
        addJavaDoc.setToolTipText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.addJavaDoc.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel34, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel34.text")); // NOI18N

        jTextField1.setColumns(20);
        jTextField1.setRows(5);
        jScrollPane1.setViewportView(jTextField1);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel1.text")); // NOI18N

        author.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.author.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel2.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel3.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel6.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel7.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel8, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel8.text")); // NOI18N

        param1.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.param1.text")); // NOI18N

        param2.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.param2.text")); // NOI18N

        param3.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.param3.text")); // NOI18N

        param4.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.param4.text")); // NOI18N

        paramReturn.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.paramReturn.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel9, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel9.text")); // NOI18N

        modCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "void", "public", "private" }));
        modCombo.setSelectedIndex(-1);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel10, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel10.text")); // NOI18N

        paramList.setText(org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.paramList.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel11, org.openide.util.NbBundle.getMessage(NewFunctionPopup.class, "NewFunctionPopup.jLabel11.text")); // NOI18N
    ...
    private void jLabel33MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel33MouseClicked
        // Help Page
        OpenHelpUrl o = new OpenHelpUrl("http://php.net/manual/en/language.functions.php");
