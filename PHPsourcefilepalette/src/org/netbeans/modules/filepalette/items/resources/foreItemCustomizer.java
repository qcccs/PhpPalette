...
import org.netbeans.modules.filepalette.items.clssmacro;
 ...
 * @author Ian
 */
public class foreItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public foreItemCustomizer(clssmacro item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-fore");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(foreItemCustomizer.class, "LBL_Customizer_InsertPrefix")
