...
import org.netbeans.modules.filepalette.items.ifemacro;
 ...
 * @author Ian
 */
public class newoItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public newoItemCustomizer(ifemacro item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-newo");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(newoItemCustomizer.class, "LBL_Customizer_InsertPrefix")
