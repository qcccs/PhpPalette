...
import org.netbeans.modules.filepalette.items.ExpressionStatement;
 ...
 * @author Ian
 */
public class ExpressionStatementPopup extends javax.swing.JPanel {

    private Dialog dialog = null;
    private DialogDescriptor descriptor = null;
    private boolean dialogOK = false;
    ExpressionStatement ifitem;
     ...
     * @param target 
     */
    public ExpressionStatementPopup(ExpressionStatement item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html_ExpressionStatement");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel9, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jLabel9.text")); // NOI18N

        arg1.setEditable(true);
        try{
            arg1.setModel(new PHPVariableNameComboModel());
        ...
        try{
            arg2.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jLabel2.text")); // NOI18N

        jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/mass/qcc/qcccodewizard/Question.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel32, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jLabel32.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addExp, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.addExp.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(ExpressionStatementPopup.class, "ExpressionStatementPopup.jLabel3.text")); // NOI18N
    ...
    private void jLabel32MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel32MouseClicked
        // Help Page
        OpenHelpUrl o = new OpenHelpUrl("http://www.php.net/manual-lookup.php?pattern=expression&src={referrer:source?}");
