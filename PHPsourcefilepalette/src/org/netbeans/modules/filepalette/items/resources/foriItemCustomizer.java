...
import org.netbeans.modules.filepalette.items.fori;
 ...
 * @author Ian
 */
public class foriItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public foriItemCustomizer(fori item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-fori");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(foriItemCustomizer.class, "LBL_Customizer_InsertPrefix")
