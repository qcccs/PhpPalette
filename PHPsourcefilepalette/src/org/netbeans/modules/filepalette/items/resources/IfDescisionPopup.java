...
public class IfDescisionPopup extends javax.swing.JPanel {
    ...
    PHPVariableNameComboModel phpvar;
    /**
    ...
    private void initComponents() {
        ...
        try{
            ifVarName.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        ifVarOp.setModel(new comparitiveOperatorListModel());

        ifVarValue.setEditable(true);
        try{
            ifVarValue.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}
    ...
    private void jLabel27MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel27MouseClicked
        // Help Page
        OpenHelpUrl o = new OpenHelpUrl("http://php.net/manual/en/control-structures.if.php");
