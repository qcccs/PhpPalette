...
import org.netbeans.modules.filepalette.items.ElseDescision;
 ...
 * @author Ian
 */
public class ElseDescisionPopup extends javax.swing.JPanel {

    private Dialog dialog = null;
    private DialogDescriptor descriptor = null;
    private boolean dialogOK = false;
    ElseDescision ifitem;
     ...
     * @param target  
     */
    public ElseDescisionPopup(ElseDescision item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-ElseDescion");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addElseButton, org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.addElseButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel29, org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.jLabel29.text")); // NOI18N

        elseBody.setColumns(20);
        elseBody.setRows(5);
        elseBody.setText(org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.elseBody.text")); // NOI18N
        jScrollPane6.setViewportView(elseBody);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel30, org.openide.util.NbBundle.getMessage(ElseDescisionPopup.class, "ElsePopup.jLabel30.text")); // NOI18N
