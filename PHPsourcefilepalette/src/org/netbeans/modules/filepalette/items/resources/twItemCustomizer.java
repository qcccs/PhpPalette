...
import org.netbeans.modules.filepalette.items.tw;
 ...
 * @author Ian
 */
public class twItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public twItemCustomizer(tw item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-tw");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(twItemCustomizer.class, "LBL_Customizer_InsertPrefix")
