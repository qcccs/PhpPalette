...
import org.netbeans.modules.filepalette.items.ForEachLoop;
 ...
 * @author Ian
 */
public class ForEachLoopPopup extends javax.swing.JPanel {
     ...
     * @param target  
     */
    public ForEachLoopPopup(ForEachLoop item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-ForEachLoop");
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel1.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jTextField1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addForEach, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.addForEach.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel28, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel28.text")); // NOI18N

        forEachName.setEditable(true);
        try{
            forEachName.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        forEachArrayName.setEditable(true);
        try{
            forEachArrayName.setModel(new PHPVariableNameComboModel());
        }catch(FileNotFoundException ex){ ex.printStackTrace();}

        org.openide.awt.Mnemonics.setLocalizedText(jLabel37, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel37.text")); // NOI18N

        forEachBody.setColumns(20);
        forEachBody.setRows(5);
        forEachBody.setText(org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.forEachBody.text")); // NOI18N
        jScrollPane7.setViewportView(forEachBody);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel38, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel38.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel2.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel3.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel35, org.openide.util.NbBundle.getMessage(ForEachLoopPopup.class, "ForEachLoopPopup.jLabel35.text")); // NOI18N
    ...
    private void addForEachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addForEachActionPerformed
        ...
        try {
            ...
            if (cvn.isGood(varName)) {
                ...
                String code = "foreach (" + varName + " as " + varArrayName + ") \n" + "{\n\t\t" + varBody + "\n}";
                try {
