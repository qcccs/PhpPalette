...
import org.netbeans.modules.filepalette.items.clsmacro;
 ...
 * @author Ian
 */
public class forcItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public forcItemCustomizer(clsmacro item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-forc");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(forcItemCustomizer.class, "LBL_Customizer_InsertPrefix")
