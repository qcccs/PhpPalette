...
import org.netbeans.modules.filepalette.items.nsmacro;
 ...
 * @author Ian
 */
public class soutItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public soutItemCustomizer(nsmacro item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.filepalette.items.resources.Bundle").getString("NAME_html-sout");
        } catch (Exception e) {}

        descriptor = new DialogDescriptor(this,
                                          NbBundle.getMessage(soutItemCustomizer.class, "LBL_Customizer_InsertPrefix")
