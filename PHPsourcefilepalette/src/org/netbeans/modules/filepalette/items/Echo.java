...
import org.netbeans.modules.filepalette.items.resources.EchoPopup;
 ...
 */
public class Echo implements ActiveEditorDrop {
    ...
    private String createBody() {
        ...
        buffer.append("echo ").append(comment).append(";\n");
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        EchoPopup c      = new EchoPopup(this, targetComponent);
