/*
 * The variables work by using the text on the radio buttons as the variable type
 */
/*
 *-----------------------------------------------------------------------------------------
...
import org.netbeans.modules.filepalette.items.resources.BasicVariablePopup;
 ...
 */
public class BasicVariable implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        BasicVariablePopup c      = new BasicVariablePopup(this, targetComponent);
